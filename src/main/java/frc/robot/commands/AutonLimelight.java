...
public class AutonLimelight extends Command {
  ...
  public void initialize() {
    this.claw.setLow();
    this.lime.turnController.setP(0.0025);
    this.lime.isTurningDone = false;
    this.lime.pickupTimer.stop();
    this.lime.pickupTimer.reset();
  }
