...
public class CenterCommand extends SequentialCommandGroup {
    ...
    public CenterCommand(ArmSubsystem arm, ClawPneumatics clawPneumatics, SwerveSubsystem drive, Pigeon2 gyro, SwerveOdometry odometry){
        this.clawPneumatics = clawPneumatics;
        this.drive = drive;
        this.arm = arm;
        this.gyro = gyro;
        this.odometry = odometry;
        this.thetaController = new ProfiledPIDController( 1, 0, 0,   new TrapezoidProfile.Constraints(Math.PI, 3));
        this.thetaController.enableContinuousInput(-Math.PI, Math.PI);
        this.kinematics = new SwerveDriveKinematics(new Translation2d(Constants.TRACKWIDTH / 2.0, Constants.WHEELBASE / 2.0),
        ...
        Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
            ...
            List.of(
                new Translation2d(1.99999999999, 0)
