 ...
 *
 * <p>In non-holonomic drive bases, the {@code y} component of the translational velocity should
 * always be 0 because they cannot move sideways.
 */
public class ChassisVelocity {
   ...
   *
   * <p>The {@code x} component of the translational velocity is the robot's forward velocity
   * (positive is forwards) and the {@code y} component is the sideways velocity (positive is to the
   * left).
   *
   ...
   *
   * <p>Positive velocities are counter-clockwise movement.
   *
