...
public final class Constants {
    ...
    public static final int BIG_ARM_ID = 6; // gear ratio is 30:1
    public static final int SMALL_ARM_ID = 31; // gear ratio is 7:1

    public static double DRIVETRAIN_FRONT_LEFT_ENCODER_OFFSET = (0.874268) * 2 * Math.PI;
    public static double DRIVETRAIN_FRONT_RIGHT_ENCODER_OFFSET = (0.319092) * 2 * Math.PI;
    public static double DRIVETRAIN_BACK_LEFT_ENCODER_OFFSET = (917480) * 2 * Math.PI;
    public static double DRIVETRAIN_BACK_RIGHT_ENCODER_OFFSET = (0.379639) * 2 * Math.PI;
