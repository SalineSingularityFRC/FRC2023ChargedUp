...
public final class Constants {
    ...
    public final static class CanCoderID {
    ...
    public final static class AngleID {
    ...
    public final static class MotorID {
    ...
    public final static class BigArmPosition {
    ...
    public final static class Canbus {
        public static final String CANBUS = "rio";
    }

    public final static class Canivore {
    ...
    public final static class WheelOffset {
    ...
    public final static class MotorGearRatio {
        public static final double DRIVE = 8.14; // this is the ratio of bot
        public static final double ANGLE = 12.8; // https://www.swervedrivespecialties.com/products/mk4-swerve-module
